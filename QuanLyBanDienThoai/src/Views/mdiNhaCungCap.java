 ...
 * @author thuan
 */
public class mdiNhaCungCap extends javax.swing.JInternalFrame {

    /**
     * Creates new form mdiNhaCungCap
     */
    DefaultTableModel tblDanhSachNhaCC;
    List<NhaCungCap> listNhaCC = new ArrayList<>();
    public String mancc, tenncc, diachi, sdt, macu;
    private boolean ktThem;

    public mdiNhaCungCap() {
        initComponents();
        tblDanhSachNhaCC = (DefaultTableModel) dgDanhSach.getModel();
        KhoaMo(true);
        Select();
    }
    ...
    public void Select() {
        listNhaCC = NhaCungCapController.Select();
        tblDanhSachNhaCC.setRowCount(0);
        listNhaCC.forEach(p -> {
            tblDanhSachNhaCC.addRow(new Object[]{
                p.getMaNCC(), p.getTenNCC(), p.getDiaChi(), p.getSDT()
            });
        });
    }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtSDT, javax.swing.GroupLayout.PREFERRED_SIZE, 412, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtDiaChi, javax.swing.GroupLayout.PREFERRED_SIZE, 412, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtMaNCC, javax.swing.GroupLayout.PREFERRED_SIZE, 412, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtTenNCC, javax.swing.GroupLayout.PREFERRED_SIZE, 412, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        macu = txtMaNCC.getText();
        int kq = JOptionPane.showConfirmDialog(this, "Bạn có muốn xoá mã nhà cung cấp [" + txtMaNCC.getText() + "] không?", "Thông báo", JOptionPane.YES_NO_OPTION);
        if (kq == JOptionPane.YES_OPTION) {
            NhaCungCapController.Delete(macu);
            XoaTrang();
            Select();
        }
    ...
    private void btnGhiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGhiActionPerformed
        // TODO add your handling code here:
        NhaCungCapController tkc = new NhaCungCapController();
        mancc = txtMaNCC.getText();
        tenncc = txtTenNCC.getText();
        diachi = txtDiaChi.getText();
        sdt = txtSDT.getText();

        if (mancc.length() <= 0 || tenncc.length() <= 0 || diachi.length() <= 0) {
            JOptionPane.showMessageDialog(this, "Bạn chưa nhập đầy đủ thông tin", "Thông báo", JOptionPane.WARNING_MESSAGE);
            return;
        }

        if (KiemTraDLController.KiemTraTrungMa("MaNCC", "nhacungcap", mancc, ktThem, macu) == true) {
            JOptionPane.showMessageDialog(this, "Bạn nhập trùng mã nhà cung cấp", "Thông báo", JOptionPane.WARNING_MESSAGE);
            txtMaNCC.requestFocus();
            return;
        }

        NhaCungCap tk = new NhaCungCap(mancc, tenncc, diachi, sdt);
        if (ktThem == true) {
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        // TODO add your handling code here:
        String tenncc = JOptionPane.showInputDialog(this, "Nhập tên nhà cung cấp cần tìm");
        if (tenncc != null && tenncc.length() > 0) {
            listNhaCC = NhaCungCapController.TimKiemTheoTenNhaCungCap(tenncc);
            tblDanhSachNhaCC.setRowCount(0);
            listNhaCC.forEach(p -> {
                tblDanhSachNhaCC.addRow(new Object[]{
                    p.getMaNCC(), p.getTenNCC(), p.getDiaChi(), p.getSDT()
